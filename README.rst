...
Stranica posvecena ucenju njemackog jezika
...
.. code-block:: bash
    ...
    cd de_pedia_ba
    celery -A de_pedia_ba.taskapp worker -l info
...
To run the tests, enter the de_pedia_ba/tests directory and run the following commands::
